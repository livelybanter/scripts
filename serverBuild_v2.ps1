...
dC9C3QAA#>
	...
	$VCenterComboBox_SelectedIndexChanged={
		...
		Write-RichText -LogType 'Informational' -LogMsg "Please Provide domain admin credentials in the form of car-vcs-01"
...
'
	...
	[void]$VCenterComboBox.Items.Add('car-vcs-01')
...
#region Source: Globals.ps1
	...
	#>
		...
		{
			'car-vcs-01' {
				$DNSString = '10.10.144.16,158.53.83.126'
			}
			'AP1-VCENTER' {
